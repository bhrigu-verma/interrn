...
// Use public paths for images to avoid mismatched static imports
const services_exploring = "/assets/img/services_exploring.jpg";
const sound_box_icon = "/assets/img/sound_box_icon.png"; // updated to .png - ensure file exists
            ...
            <div className="cs_service_exploring_2">
              <div className="cs_service_exploring_img">
                <div className="anim_div_ShowRightSide">
                  <Image src={services_exploring} className="cs_img" alt="services_exploring" width={700} height={420} />
                </div>
                <div className="cs_service_exploring_img_text cs_style_1 cs_color_1 anim_div_ShowDowns">
                  <Image src={sound_box_icon} alt="sound_box_icon" width={64} height={64} />
